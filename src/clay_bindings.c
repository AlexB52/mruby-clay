...
mrb_value mrb_clay_color(mrb_state* mrb, Clay_Color color) {
  ...
  mrb_hash_set(mrb, result, mrb_str_new_lit(mrb, "r"), mrb_float_value(mrb, round_to_1_decimal(color.r)));
  mrb_hash_set(mrb, result, mrb_str_new_lit(mrb, "g"), mrb_float_value(mrb, round_to_1_decimal(color.g)));
  mrb_hash_set(mrb, result, mrb_str_new_lit(mrb, "b"), mrb_float_value(mrb, round_to_1_decimal(color.b)));
  mrb_hash_set(mrb, result, mrb_str_new_lit(mrb, "a"), mrb_float_value(mrb, round_to_1_decimal(color.a)));
  return result;
}
