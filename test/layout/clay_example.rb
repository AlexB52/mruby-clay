class TestClayExample < MTest::Unit::TestCase
  ...
  COLOR_120 = Clay::Colors.build(140, 140, 140, 255)
    ...
    Clay.ui(
      ...
      Clay.ui(
        ...
        layout: {
          ...
          padding: Clay::Padding[16, 16, 0, 0],
          child_gap: 16,
          child_alignment: Clay::ChildAlignment[:top, :center],
        },
      ) do
        Clay.ui(
          id: "FileButton",
          layout: { padding: Clay::Padding[16, 16, 8, 8] },
          background_color: Clay::Colors.build(140, 140, 140, 255),
          corner_radius: Clay::Corners[5]
        ) do
          Clay.text("File", color: COLOR_255.to_h)
        end
        render_header_button("Edit")
        Clay.ui(layout: { sizing: { width: Clay::Sizing.grow }})
      ...
      Clay.ui(
        ...
        Clay.text(<<~TEXT, color: COLOR_255.to_h)
          Squirrels
