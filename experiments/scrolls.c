...
int main() {
  ...
  while (1) {
    ...
    snprintf(rightText, sizeof(rightText), "%.1f,%.1f - %.1f,%.1f - %d", pointerPos.x, pointerPos.y, scrollX, scrollY,
             isMouseDown);
    ...
    CLAY(CLAY_ID("root"), {.backgroundColor = COLOR_RED,
      ...
      CLAY(CLAY_ID("FIRST"),
        ...
        CLAY_TEXT(
            CLAY_STRING("Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed "
